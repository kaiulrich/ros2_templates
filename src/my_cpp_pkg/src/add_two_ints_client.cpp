...
public:
    ...
    {
        threads_.push_back(thread(bind(&AddTwoIntsClientNode::callAddTwoIntsService, this, 1, 4)));
        threads_.push_back(thread(bind(&AddTwoIntsClientNode::callAddTwoIntsService, this, 4, 5)));
    }
